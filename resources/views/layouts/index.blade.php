...
<head>
  ...
  <title>Sinar Fajar | @yield('title')</title>
  ...
  <link rel="stylesheet" href="{{ asset('vendor/AdminLTE-3.1.0') }}/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css">
  <!-- iCheck -->
  <link rel="stylesheet" href="{{ asset('vendor/AdminLTE-3.1.0') }}/plugins/icheck-bootstrap/icheck-bootstrap.min.css">
  <!-- JQVMap -->
  <link rel="stylesheet" href="{{ asset('vendor/AdminLTE-3.1.0') }}/plugins/jqvmap/jqvmap.min.css">
  <!-- Theme style -->
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{ asset('vendor/AdminLTE-3.1.0') }}/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="60" width="60">
  </div>
...
<!-- jQuery UI 1.11.4 -->
<script src="{{ asset('vendor/AdminLTE-3.1.0') }}/plugins/jquery-ui/jquery-ui.min.js"></script>
...
<!-- Sparkline -->
<script src="{{ asset('vendor/AdminLTE-3.1.0') }}/plugins/sparklines/sparkline.js"></script>
<!-- JQVMap -->
<script src="{{ asset('vendor/AdminLTE-3.1.0') }}/plugins/jqvmap/jquery.vmap.min.js"></script>
<script src="{{ asset('vendor/AdminLTE-3.1.0') }}/plugins/jqvmap/maps/jquery.vmap.usa.js"></script>
<!-- jQuery Knob Chart -->
<script src="{{ asset('vendor/AdminLTE-3.1.0') }}/plugins/jquery-knob/jquery.knob.min.js"></script>
<!-- daterangepicker -->
...
<!-- Tempusdominus Bootstrap 4 -->
<script src="{{ asset('vendor/AdminLTE-3.1.0') }}/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js"></script>
<!-- Summernote -->
<script src="{{ asset('vendor/AdminLTE-3.1.0') }}/plugins/summernote/summernote-bs4.min.js"></script>
<!-- overlayScrollbars -->
